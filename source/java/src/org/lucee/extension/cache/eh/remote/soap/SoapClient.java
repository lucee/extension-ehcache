...
public class SoapClient {
	...
	public Cache getCache(String cacheName) throws Exception {
       ...
       ClassUtil cu = CFMLEngineFactory.getInstance().getClassUtil();
       Class<?> clazz = cu.loadClass("lucee.runtime.net.rpc.TypeMappingUtil");
       cu.callStaticMethod(clazz, "registerBeanTypeMapping", new Object[]{
    		   tm,
